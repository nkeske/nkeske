<!--
    Personalized, modern GitHub Profile README for Nazlıgül Keske
    Tailored with a stylish design approach.
-->
...
<!-- Introduction in a stylish card layout -->
...
<!-- Skills Section with Badges (Modern Gradient Style) -->
